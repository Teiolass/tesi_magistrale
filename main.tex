...
\begin{algorithmic}
    ...
    \Function{DTW}{$s$, $t$} \Comment{Computes the DTW distance between $s$ and $t$}
        ...
        \For{$i \gets 1\dots n$}
            \For{$j \gets 1\dots m$}
                ...
                % \Comment{The minimum corresponds respectively to a insertion, a deletion or a match.}
            \EndFor
        \EndFor
...
\begin{figure}[!tb] 
\makebox[\textwidth][c]{\includegraphics[width=\textwidth]{explanation.png}}
\caption{
