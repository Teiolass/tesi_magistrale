...
the prediction of future analysis given the patient history in the form of EHR. This is a nontrivial
task given the high dimensionality of the problem and its temporal dependencies. However several
approaches in the field of deep learning have been proposed to tackle this task, mainly based on
recurrent architectures \deb{citazioni} and transformer-based architectures have been started to be
explored \deb{altre citazioni}.
...
the inner reasoning of deep learning models in human terms. Work has been conducted in the last
